    ...
    const stylistProfiles =
      profileQuery.length
        ? await Stylist.find({
            ...
            .select(
              "userAccount email firstName lastName jobTitle profileImage profilePublished bookable isActive workingHours services phone createdAt updatedAt"
            )
            .populate(
              "services",
