...
} from "./aiDemandForecastingService.js";
...
function demandForecastOptions(
  query = {}
) {
  return {
    asOfDate:
    ...
    targetUtilisation:
      query.targetUtilisation,

    appointmentsPerStaffHour:
      query.appointmentsPerStaffHour,

    staffShiftHours:
      query.staffShiftHours,
...
export async function generateAppointmentDemandForecast(
  ...
  const result =
    await createAiAppointmentDemandForecast({
  ...
  return response.status(200).json({
    ...
    message:
      "AI appointment-demand forecast generated successfully.",
