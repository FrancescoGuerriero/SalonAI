...
export default function Services() {
    ...
    try {
      ...
      setError(
        requestError
          .response?.data
          ?.message ||
          "We could not load the published service list. Please try again."
      );
    } finally {
      setLoading(false);
    }
  ...
  function handleSelect(
    ...
    if (
      ...
      setError(
        "The booking session is unavailable."
      );
      return;
    }
  ...
  function handleConsult(
    ...
    if (!whatsappUrl) {
      setError(
        "WhatsApp booking is not configured yet. Please use the standard booking option or contact the salon."
      );
      return;
    }
      ...
      <div className="customer-page-container">
        <header className="customer-page-header">
          <div>
            ...
            <p>
              Browse the salon's published service list and current prices.
              Choose a service to continue to booking, or start a consultation
              through WhatsApp where required.
            </p>
          </div>
        </header>
        ...
        filteredServices.length ===
          ...
          <EmptyState
            ...
            title={
              services.length ===
              0
                ? "The service list is not available yet"
