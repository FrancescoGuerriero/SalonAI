  ...
  return (
    ...
    >
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        {!canManagePermissions ? <p className="mt-4 text-xs text-slate-500">Only Super Admin and Admin can grant or remove employee-specific special permissions. Super Admin accounts remain protected.</p> : null}
      </section>
    </main>
  );
}
